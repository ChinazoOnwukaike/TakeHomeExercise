    ...
    return (
      <main className="max-w-5xl mx-auto px-4 py-12">
        <p className="text-red-600">
          Could not connect to the backend. Make sure the Flask server is
  ...
  return (
    <>
      <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center gap-3">
        <span className="text-brand-dark font-bold text-lg tracking-widest uppercase">
          Terralytiq
        </span>
      </header>
      <main className="max-w-7xl mx-auto w-full px-8 py-10">
        ...
        <p className="text-sm text-brand-muted mb-6">
          Per-unit carbon footprint. Expand a component to see materials and
          production blocks.
        </p>
